...
class TestAuditMigrationsCommand(TestCase):
    ...
    def test_audit_command_clean_state(
        self, mock_extractor_class, mock_introspect, mock_load_history
    ):
    ...
    @patch("django_migration_audit.management.commands.audit_migrations.introspect_schema")
    @patch("django_migration_audit.management.commands.audit_migrations.MigrationExtractor")
    def test_audit_command_comparison_b_only(
        self, mock_extractor_class, mock_introspect, mock_load_history
    ):
    ...
    @patch("django_migration_audit.management.commands.audit_migrations.introspect_schema")
    @patch("django_migration_audit.management.commands.audit_migrations.MigrationExtractor")
    def test_audit_command_custom_database(
        self, mock_extractor_class, mock_introspect, mock_load_history, mock_connections
    ):
    ...
    @patch("django_migration_audit.management.commands.audit_migrations.introspect_schema")
    @patch("django_migration_audit.management.commands.audit_migrations.MigrationExtractor")
    def test_audit_command_output_format(
        self, mock_extractor_class, mock_introspect, mock_load_history
    ):
        ...
        schema = SchemaState(tables={"app1_model": TableState(name="app1_model", columns={})})
        mock_extractor = Mock()
        mock_extractor.build_state.return_value = schema
        mock_extractor_class.return_value = mock_extractor
        mock_introspect.return_value = schema
    ...
    @patch("django_migration_audit.management.commands.audit_migrations.introspect_schema")
    @patch("django_migration_audit.management.commands.audit_migrations.MigrationExtractor")
    def test_audit_command_error_and_warning_counts(
        self, mock_extractor_class, mock_introspect, mock_load_history
    ):
        ...
        expected_schema = SchemaState(
            tables={"expected_table": TableState(name="expected_table", columns={})}
        )
        actual_schema = SchemaState(
            tables={"unexpected_table": TableState(name="unexpected_table", columns={})}
        )
