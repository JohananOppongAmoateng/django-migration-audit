...
manage *COMMAND:
    ...
    os.environ["DJANGO_SETTINGS_MODULE"] = "django_migration_audit.tests.debug"
...
check-types:
    #TODO @just run mypy src/django_migration_audit
...
make-test-migrations:
    - rm src/django_migration_audit/tests/migrations/00*.py
    - rm src/django_migration_audit/tests/deletion/migrations/00*.py
